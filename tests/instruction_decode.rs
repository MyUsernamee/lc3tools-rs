use lc3tools_rs::{Instruction, Register, Operand};
...
fn test_decode_add() {
    ...
    assert_eq!(reg_instr, Instruction::ADD { 
        dr: Register::R1,
        sr1: Register::R2,
        op: Operand::Register(Register::R4)
    });
    assert_eq!(imm_instr, Instruction::ADD { 
        dr: Register::R1,
        sr1: Register::R2,
...
fn test_decode_and() {
    ...
    assert_eq!(reg_instr, Instruction::AND { 
        dr: Register::R1,
        sr1: Register::R2,
        op: Operand::Register(Register::R4)
    });
    assert_eq!(imm_instr, Instruction::AND { 
        dr: Register::R1,
        sr1: Register::R2,
        op: Operand::Immediate(0b01010)
    });
...
fn test_decode_br() {
    ...
    assert_eq!(n_instr, Instruction::BR { 
        n: true,
        z: false,
        p: false,
        offset: 0b010000100
    });
    assert_eq!(z_instr, Instruction::BR { 
        n: false,
        z: true,
        p: false,
        offset: 0b010000100
    });
    assert_eq!(p_instr, Instruction::BR { 
        n: false,
        z: false,
        p: true,
        offset: 0b010000100
...
fn test_decode_ldr() {
    ...
    assert_eq!(instr, Instruction::LDR { dr: Register::R4, base_r: Register::R2, offset: 0b010010u16});
}
...
fn test_decode_str() {
    ...
    assert_eq!(instr, Instruction::STR { sr: Register::R4, base_r: Register::R2, offset: 0b010010u16});
}
